...
namespace RecursiveTree\Seat\PricesCore\Utils;

use Composer\InstalledVersions;
use OutOfBoundsException;
use RecursiveTree\Seat\PricesCore\PricesServiceProvider;
...
class UserAgentBuilder
{
    ...
    public function defaultComments(): UserAgentBuilder {
        $this->comment(sprintf('(admin contact: %s)', setting('admin_contact', true)));
        $this->commentSeatPlugin(PricesServiceProvider::class);
